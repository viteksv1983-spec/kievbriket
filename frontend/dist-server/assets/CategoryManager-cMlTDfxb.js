  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6 max-w-5xl", children: [
    ...
    editingCategory && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm overflow-y-auto", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl w-full max-w-2xl p-6 relative", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "Лейбл на картці (Хіт продажу, тощо)" }),
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "text",
          ...
          /* @__PURE__ */ jsx("div", { className: "flex items-center mt-6", children: /* @__PURE__ */ jsxs("label", { className: "flex items-center gap-3 cursor-pointer", children: [
            /* @__PURE__ */ jsx(
              "input",
              {
                type: "checkbox",
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-4", children: localCategories.map((cat) => /* @__PURE__ */ jsxs("div", { className: "bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow flex flex-col sm:flex-row gap-4 sm:gap-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col justify-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2 mb-4", children: [
          cat.is_available === false ? /* @__PURE__ */ jsx("span", { className: "px-2 py-1 bg-red-100 text-red-700 rounded text-xs font-bold", children: "Немає в наявності" }) : /* @__PURE__ */ jsx("span", { className: "px-2 py-1 bg-green-100 text-green-700 rounded text-xs font-bold", children: "В наявності" }),
          cat.label_text && /* @__PURE__ */ jsxs("span", { className: "px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-bold font-mono", children: [
            '"',
            cat.label_text,
            '"'
          ] })
...
//# sourceMappingURL=CategoryManager-cMlTDfxb.js.map
