...
function Login() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "min-h-screen flex items-center justify-center bg-[#FDFBF7] py-12 px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsx(
      SEOHead,
      {
...
//# sourceMappingURL=Login-BcEC_aYy.js.map
