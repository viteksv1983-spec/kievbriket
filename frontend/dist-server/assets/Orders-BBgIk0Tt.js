...
import { u as useAuth, a as api } from "../entry-server.js";
...
function Orders() {
  ...
  const handleCopyOrder = (order) => {
    const itemsText = order.items.map(
      (item) => `- ${item.product?.name || "Дрова"} x${item.quantity}${item.flavor ? ` (${item.flavor})` : ""}${item.weight ? ` [${item.weight}кг]` : ""}`
    ).join("\n");
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-5xl", children: [
      /* @__PURE__ */ jsx("div", { className: "hidden md:block overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-left text-xs text-gray-600 min-w-[800px]", children: [
        /* @__PURE__ */ jsx("thead", { className: "bg-gray-50/50 text-gray-400 font-bold uppercase text-[10px] tracking-widest border-b border-gray-100", children: /* @__PURE__ */ jsxs("tr", { children: [
          ...
          /* @__PURE__ */ jsx("th", { className: "px-6 py-4 w-36 text-center", children: "Доставка" }),
          /* @__PURE__ */ jsx("th", { className: "px-6 py-4 w-24 text-center", children: "Сума" }),
          /* @__PURE__ */ jsx("th", { className: "px-6 py-4 w-32 text-right", children: "Статус" }),
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: orders.map((order) => /* @__PURE__ */ jsxs(
          "tr",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-center", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center gap-1", children: /* @__PURE__ */ jsx("div", { className: `text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded-full border ${order.delivery_method === "uklon" ? "bg-blue-50 text-blue-600 border-blue-100" : "bg-green-50 text-green-600 border-green-100"}`, children: order.delivery_method === "uklon" ? "🚕 Uklon" : "🏪 Самовивіз" }) }) }),
              ...
              /* @__PURE__ */ jsx("td", { className: "px-6 py-4 text-right", onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxs(
                "select",
                {
                  ...
                  className: `px-2 py-1 rounded-lg text-[10px] font-bold uppercase tracking-wider border transition-all cursor-pointer focus:outline-none w-full ${order.status === "completed" ? "bg-green-50 text-green-600 border-green-200" : order.status === "processing" ? "bg-blue-50 text-blue-600 border-blue-200" : order.status === "cancelled" ? "bg-gray-50 text-gray-400 border-gray-200" : "bg-amber-50 text-amber-600 border-amber-200"}`,
                  children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "md:hidden divide-y divide-gray-100", children: orders.map((order) => /* @__PURE__ */ jsxs("div", { className: "p-4 bg-white hover:bg-yellow-50/20 active:bg-yellow-50/50 cursor-pointer", onClick: () => setSelectedOrder(order), children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-3", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx(FiUser, { className: "w-3.5 h-3.5 text-gray-400" }),
            /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-gray-700 truncate max-w-[120px]", children: order.customer_name || "Гість" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: `text-[8px] font-bold uppercase tracking-widest px-1.5 py-0.5 rounded border ${order.delivery_method === "uklon" ? "bg-blue-50 text-blue-600 border-blue-100" : "bg-green-50 text-green-600 border-green-100"}`, children: order.delivery_method === "uklon" ? "🚕 Uklon" : "🏪 Самовивіз" })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex justify-end items-center", children: /* @__PURE__ */ jsx("div", { onClick: (e) => e.stopPropagation(), children: /* @__PURE__ */ jsxs(
          "select",
          {
            value: order.status,
            onChange: (e) => handleStatusChange(order.id, e.target.value),
            className: `px-2 py-1 rounded-md text-[9px] font-bold uppercase tracking-wider border transition-all cursor-pointer focus:outline-none ${order.status === "completed" ? "bg-green-50 text-green-600 border-green-200" : order.status === "processing" ? "bg-blue-50 text-blue-600 border-blue-200" : order.status === "cancelled" ? "bg-gray-50 text-gray-400 border-gray-200" : "bg-amber-50 text-amber-600 border-amber-200"}`,
            children: [
              /* @__PURE__ */ jsx("option", { value: "pending", children: "Очікує" }),
              /* @__PURE__ */ jsx("option", { value: "processing", children: "В роботі" }),
              /* @__PURE__ */ jsx("option", { value: "completed", children: "Виконано" }),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto p-6 space-y-8", children: [
            ...
            /* @__PURE__ */ jsxs("section", { className: "space-y-4", children: [
              /* @__PURE__ */ jsx("h3", { className: "text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]", children: "Доставка та Товари" }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-4 rounded-2xl border-2 border-dashed border-gray-100 bg-white shadow-sm", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                  /* @__PURE__ */ jsx("div", { className: `w-10 h-10 rounded-xl flex items-center justify-center ${selectedOrder.delivery_method === "uklon" ? "bg-blue-50 text-blue-600" : "bg-green-50 text-green-600"}`, children: selectedOrder.delivery_method === "uklon" ? /* @__PURE__ */ jsx(FiTruck, { className: "w-5 h-5" }) : /* @__PURE__ */ jsx(FiPackage, { className: "w-5 h-5" }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-gray-900 uppercase tracking-tight", children: selectedOrder.delivery_method === "uklon" ? "Таксі Uklon" : "Самовивіз з цеху" }),
                    /* @__PURE__ */ jsx("div", { className: "text-[10px] text-gray-500 font-medium", children: "Метод доставки" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
                  /* @__PURE__ */ jsx("div", { className: "text-xs font-bold text-gray-900", children: selectedOrder.delivery_date || "-" }),
                  /* @__PURE__ */ jsx("div", { className: "text-[10px] text-gray-400 font-medium uppercase tracking-tighter", children: "Дата доставки" })
                ] })
              ] }),
...
//# sourceMappingURL=Orders-BBgIk0Tt.js.map
