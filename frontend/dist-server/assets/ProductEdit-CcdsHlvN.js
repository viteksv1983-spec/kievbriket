        ...
        if (isBriket) {
          if (!autoSeoTitle) {
            ...
            if (nameLower.includes("ruf") && nameLower.includes("дуб")) {
              autoSeoTitle = `Купити брикети RUF дуб у Києві — доставка | КиївБрикет`;
            } else if (nameLower.includes("pini kay") || nameLower.includes("піні кей")) {
              autoSeoTitle = `Купити брикети Pini Kay у Києві — євродрова | КиївБрикет`;
            } else if (nameLower.includes("nestro") || nameLower.includes("нестро")) {
              autoSeoTitle = `Купити брикети Nestro у Києві — циліндричні брикети | КиївБрикет`;
            } else if (nameLower.includes("торф") || nameLower.includes("torf")) {
              autoSeoTitle = `Купити торфобрикети у Києві — економне опалення | КиївБрикет`;
            } else {
              autoSeoTitle = `Купити ${data.name.toLowerCase()} у Києві — доставка | КиївБрикет`;
            }
          }
          if (!autoSeoDesc) {
            wasAutoGenerated = true;
...
//# sourceMappingURL=ProductEdit-CcdsHlvN.js.map
