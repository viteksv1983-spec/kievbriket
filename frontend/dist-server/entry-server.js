...
import React, { Component, createContext, useContext, useState, useEffect, useRef, useCallback, Suspense } from "react";
import { renderToString } from "react-dom/server";
import { useLocation, Link, Outlet, Navigate, Routes, Route, StaticRouter } from "react-router-dom";
import fastCompare from "react-fast-compare";
import invariant from "invariant";
import shallowEqual from "shallowequal";
import axios from "axios";
import { Flame, ShoppingCart, Truck, MapPin, Phone, X, Menu, ChevronRight, Clock, Mail, CheckCircle2, Loader2, ArrowRight, Star, Scale, Leaf, CreditCard, Package, Quote, ChevronDown, Ruler, Banknote, TreePine, Calculator, Thermometer, Home as Home$1 } from "lucide-react";
...
function Home() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(FaqSection, { faqs: faqQuestions }),
...
const Delivery = React.lazy(() => import("./assets/Delivery-yiPBfvAH.js"));
const Contacts = React.lazy(() => import("./assets/Contacts-DMMqQWzS.js"));
const About = React.lazy(() => import("./assets/About-J2FGhNmX.js"));
const DynamicPage = React.lazy(() => import("./assets/DynamicPage-ByQHfS2i.js"));
const AdminLayout = React.lazy(() => import("./assets/AdminLayout-fz8nD-dm.js"));
const Orders = React.lazy(() => import("./assets/Orders-WiI9290P.js"));
const Products = React.lazy(() => import("./assets/Products-D3uAVAdT.js"));
const ProductEdit = React.lazy(() => import("./assets/ProductEdit-B0ratLJm.js"));
const PageEditor = React.lazy(() => import("./assets/PageEditor-Cmujr7KF.js"));
const CategoryManager = React.lazy(() => import("./assets/CategoryManager-BIlqku0L.js"));
React.lazy(() => import("./assets/SEOPages-BTbcHUzq.js"));
const TelegramSettings = React.lazy(() => import("./assets/TelegramSettings-CeUe8uW3.js"));
const SiteSettingsPage = React.lazy(() => import("./assets/SiteSettingsPage-BRMDvs2f.js"));
function App() {
...
export {
  AuthContext as A,
  BenefitsSection as B,
  CartContext as C,
  DeliverySection as D,
  FuelCalculatorSection as F,
  NotFound as N,
  OrderFormModal as O,
  SEOHead as S,
  getImageUrl as a,
