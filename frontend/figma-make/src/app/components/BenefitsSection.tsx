...
import {
  Clock, Truck, Scale, Leaf, CreditCard, ShieldCheck,
} from "lucide-react";
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 1.5rem" }}>
        ...
        >
          {items.map((item, i) => (
            <div
              key={item.title}
              className={`card benefit-card${item.hero ? " benefit-hero" : ""} reveal ${visible ? "visible" : ""}`}
              style={{
                padding: "1.75rem",
      ...
      <style>{`
        ...
        @media (max-width: 479px) {
          ...
          .benefits-grid .card { padding: 1.25rem !important; }
        }
        .benefit-card {
        ...
        .benefit-hero {
          ...
          box-shadow: 0 0 24px rgba(249,115,22,0.10), inset 0 0 40px rgba(249,115,22,0.04) !important;
        }
        .benefit-card:hover {
