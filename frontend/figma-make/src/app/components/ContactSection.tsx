...
export function ContactSection() {
  ...
  return (
    ...
    >
      {/* Gradient bridge — blends CtaBanner's dark image edge into var(--c-bg) */}
      <div style={{
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "5rem", alignItems: "start" }} className="contact-grid">
          ...
          <div className={`reveal ${visible ? "visible" : ""}`}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 40 }}>
              {[
                { Icon: Phone, text: "+38 067 883 28 10", href: "tel:+380678832810", label: "Телефон" },
                { Icon: Phone, text: "+38 099 665 74 77", href: "tel:+380996657477", label: "Телефон" },
