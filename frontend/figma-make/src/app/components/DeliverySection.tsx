...
// Спрощений контур Київської області (SVG-шлях, viewBox 400×300)
// Київ — у точці (200, 158), трохи нижче центру (місто знаходиться в центрально-південній частині області)
const OBLAST_PATH =
...
function KyivMap({ hoveredZone }: { hoveredZone: string | null }) {
  ...
  return (
    ...
    >
      <defs>
        ...
        {/* Фоновий градієнт: центр світліший */}
      ...
      {/* Шар шуму (поверх фону, під контентом) */}
      <rect
...
export function DeliverySection() {
  ...
  return (
    ...
    >
      {/* Gradient bridge — blends from green section into dark bg */}
      <div style={{
      ...
      <style>{`
        ...
        @media (max-width: 479px) {
          ...
          /* Zone cards compact */
          .delivery-grid .card { padding: 1rem !important; }
        }
      `}</style>
    </section>
  );
