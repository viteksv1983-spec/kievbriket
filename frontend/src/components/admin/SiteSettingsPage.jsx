        ...
        <div style={{ maxWidth: 640 }}>
            <div style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: '#6b7280', fontSize: '0.875rem' }}>
                    Вставте код відстеження Google Analytics. Він буде працювати на всіх сторінках сайту.
                </p>
            </div>
            ...
            <form onSubmit={handleSave}>
                <div style={{
                    ...
                    <p style={{ color: '#9ca3af', fontSize: '0.75rem', marginTop: 6 }}>
                        Знайдіть його в Google Analytics → Адмін → Потоки даних → Ідентифікатор
                    </p>
                </div>
                ...
                <div style={{
                    ...
                    <strong>💡 Підказка:</strong> Вставте тільки Measurement ID (наприклад <code style={{ background: '#fef3c7', padding: '1px 6px', borderRadius: 4 }}>G-ABC123XYZ</code>).
