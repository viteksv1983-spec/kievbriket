            ...
            <div className="seo-box">
                ...
                <div className="seo-grid">
                    ...
                    <div className="seo-text">
                        <p>
                            Компанія «КиївДрова» постачає тверде паливо для опалення будинків,
                            котлів та камінів.
                        </p>
                        <p>
                    ...
                    <div className="seo-strips">
                        <div className="seo-strip">
                            ...
                            <div className="seo-strip-body">
                                ...
                                <p className="seo-strip-desc">Власний транспорт, доставка за 24 години</p>
                            </div>
                        </div>
                    ...
                    <div className="seo-grid">
                        ...
                        <div>
                            <div className="seo-text seo-text-wide">
                                <p>
                                    Компанія «КиївДрова» — надійний постачальник твердого палива
                                    з доставкою по Києву та Київській області.
                                </p>
                                <p>
...
/* ═══════════════════════════════════════════════════════════════
   SSR SEO CONTENT BLOCK — rendered fully during SSR, no useEffect
   ~3000 characters of natural Ukrainian SEO text
═══════════════════════════════════════════════════════════════ */
export function SeoContentBlock() {
    return (
        <section className="seo-content" style={{ padding: '0 24px 60px' }}>
            <div style={{
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{ margin: '0 0 16px' }}>
                            Ми працюємо без передоплати — ви оплачуєте замовлення лише після отримання та перевірки якості та об'єму. Чесний складометр, гарантована вологість, сертифіковане вугілля — все це входить у стандарт обслуговування «КиївДрова». Замовляйте тверде паливо онлайн або за телефоном — ми завжди на зв'язку.
                        </p>
                    </div>
                </div>
            </div>
